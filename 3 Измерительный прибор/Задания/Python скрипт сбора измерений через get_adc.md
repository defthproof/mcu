...
19. запустить скрипт с прошивкой `03-adc`, убедиться, что данные считываются и выводятся в терминал:

![[Pasted image 20260219014727.png]]

20. В блок `finally` добавить построение графика зависимости напряжения и температуры от времени:
...
21. В конце файла добавить вызов функции `main`:
